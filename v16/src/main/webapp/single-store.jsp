...
<head>
    ...
    <!-- Title -->
    <title>Chop - Food Blog HTML Template</title>
                ...
                <div class="col-12 col-lg-8 col-xl-9">
                    <div class="post-details-content mb-100">
                        <div class="blog-thumbnail mb-50">
                            <img src="img/bg-img/1910151644.jpg" alt="">
                        </div>
                        <div class="blog-content">
                            <a href="#" class="post-tag">카테고리</a>
                            <h4 class="post-title">상품 이름</h4>
                            <h4 class="post-price">5,000원</h4>
                            <div class="post-meta mb-50">
                                <a href="#" class="post-date">2019.10.15</a>
                                <a href="#" class="post-author">판매자 이름</a>
                                <button class="btn bueno-btn w-100">구매하기</button>
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-content d-flex">
                                    ...
                                    <div class="comment-meta">
                                        <div class="d-flex">
                                            <a href="#" class="post-author">댓글작성자이름</a>
                                            <a href="#" class="post-date">2019.10.15</a>
